...
local cBase     = CreateConVar( "hl2bl_encounter_base",     "6",    FCVAR_ARCHIVE, "Base enemies per encounter (before scaling)." )
local cMaxBudget= CreateConVar( "hl2bl_encounter_max",      "30",   FCVAR_ARCHIVE, "Hard cap on enemies per encounter." )
local cCooldown = CreateConVar( "hl2bl_encounter_cooldown", "20",   FCVAR_ARCHIVE, "Seconds after a clear before the next encounter." )
local cTravel   = CreateConVar( "hl2bl_encounter_travel",   "1200", FCVAR_ARCHIVE, "Distance the group must move to start a new encounter." )
local cWave     = CreateConVar( "hl2bl_spawn_wave",         "3",    FCVAR_ARCHIVE, "Enemies spawned per director tick." )
local cConc     = CreateConVar( "hl2bl_spawn_max",          "10",   FCVAR_ARCHIVE, "Base concurrent alive cap during an encounter." )
